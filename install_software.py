...
"""
    ...
    def setup_k8s_cluster(self) -> bool:
        ...
        for cluster_name, vms in clusters_vms.items():
            ...
            # Initialize master with custom pod_cidr
            ...
            # Install Flannel CNI with custom pod_cidr
    ...
    def print_summary(self) -> None:
        ...
        if all_success:
            ...
            print("\nNext steps:")
            if master_nodes:
                print(f"  1. Check cluster status: python3 vmctl.py ssh {master_nodes[0]} 'kubectl get nodes'")
                print(f"  2. Check pods: python3 vmctl.py ssh {master_nodes[0]} 'kubectl get pods -A'")
            print("  3. SSH into VM: python3 vmctl.py ssh <vm-name>")
        else:
            print("\n✗ Some VMs failed to install properly")
            print("\nTroubleshooting:")
